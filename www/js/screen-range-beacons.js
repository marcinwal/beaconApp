...
;(function(app)
{
	...
	app.startRangingBeacons = function()
	{
      ...
      //checking if becound is found or lost

    	if (found)
    	{

    		checkIfBeaconLost(yourBeacon,beaconInfo,heroku_path)

    	}

      // beaconFound(beacon,"I found you Beacon",local_path);
      ...
      beaconFound(beacon,"I found you Beacon",heroku_path);
